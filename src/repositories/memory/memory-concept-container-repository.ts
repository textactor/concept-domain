...
import { ConceptContainerRepository, ContainerListFilters } from '../concept-container-repository';
import { ConceptContainer, ConceptContainerStatus } from '../../entities/concept-container';
import { MemoryRepository } from './memory-repository';

export class MemoryConceptContainerRepository extends MemoryRepository<ConceptContainer> implements ConceptContainerRepository {
    constructor() {
        super()
    }
